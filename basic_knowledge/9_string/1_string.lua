...
print(string.upper(argument))       --字符串全部转为大写字母。
print('--------------')
print(string.lower(argument))       --字符串全部转为小写字母。
print('--------------')
print(string.gsub(mainString,findString,replaceString,num))
--在字符串中替换。
